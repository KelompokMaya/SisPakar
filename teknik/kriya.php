                  ...
                  while($row = mysqli_fetch_assoc($sql)){
                    ...
                    ?>
                              <tr>
                                  ...
                                  <td style="text-align: center;width: 20px;"><a href="kriya.php?view=<?php echo $row['id'];?>" class="btn btn-sm btn-info"   ><span  aria-hidden="true"></span> Lihat </a></td>
                            </tr>
                          <?php
                           $no++;
